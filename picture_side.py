...
#Set bounding box and resolution
        PovRay.kwargs['rotation']='270x,270y,0z'
        #PovRay.kwargs['bbox']=(15, 14, 29, 27) ## the bbox defines the area of the figure is its x1,Y1, X2,Y2 on the diagonal 
...
#PovRay.set_specific_textures(at,at_text)
        ...
        renderer = write(l+'_side.pov',A,**PovRay.kwargs)
